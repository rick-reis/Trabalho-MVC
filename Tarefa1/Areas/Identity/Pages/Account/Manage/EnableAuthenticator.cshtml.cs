...
namespace Tarefa1.Areas.Identity.Pages.Account.Manage
{
    public class EnableAuthenticatorModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            _logger.LogInformation("O utilizador com o ID '{UserId}' ativou um 2FA com uma app de autenticação.", userId);

            StatusMessage = "A sua app de autenticação foi verificada.";
